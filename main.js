...
//https://script.google.com/macros/s/AKfycbzA9Hbs0kh9vG8-RDlc62eZbU30COOhpnUMeMzdJyDn7Zs0-TXM-X8zi76sN5WJfbDCRQ/exec
console.log("Start");
...
function loadNames() {
  ...
  function submitForm() {
    ...
    const duration = `${Math.floor(durationMin / 60)}:${("0" + (durationMin % 60)).slice(-2)}`;
